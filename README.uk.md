...
- **Windows release checks безпечно охоплюють launcher.** Тести поведінки macOS
  тепер мають платформний scope, а release archives зберігають Windows-safe
  launcher stub, тому всі підтримувані targets чисто збираються й тестуються.
