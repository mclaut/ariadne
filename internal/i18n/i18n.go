...
var table = map[Lang]map[string]string{
	EN: {
		...
		"approval.prompt_help": "Approve only if you initiated this request. Closing the window or choosing Later grants no access.",
	...
	UK: {
		...
		"approval.prompt_help": "Схвалюйте лише запити, які ініціювали ви. Закриття вікна або вибір «Пізніше» не надає доступу.",
